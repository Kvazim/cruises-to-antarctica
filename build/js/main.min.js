...
/* harmony import */ var _modules_nojs_nojs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/nojs/nojs */ "./js/modules/nojs/nojs.js");
/* harmony import */ var _modules_toggle_button_togle_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggle-button/togle-button */ "./js/modules/toggle-button/togle-button.js");
/* harmony import */ var _modules_smooth_scroll_smooth_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/smooth-scroll/smooth-scroll */ "./js/modules/smooth-scroll/smooth-scroll.js");
/* harmony import */ var _modules_smooth_scroll_smooth_scroll__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_smooth_scroll_smooth_scroll__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_map_map__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/map/map */ "./js/modules/map/map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_nojs_nojs__WEBPACK_IMPORTED_MODULE_2__["removeNoJs"])();
  Object(_modules_toggle_button_togle_button__WEBPACK_IMPORTED_MODULE_3__["initToggle"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_map_map__WEBPACK_IMPORTED_MODULE_5__["initMap"])();
  });
});
...
var createMap = function createMap() {
  ...
  function init() {
    ...
    var myPlacemark = new ymaps.Placemark([СOORDINATES_PIN.lat, СOORDINATES_PIN.lng], {
...
/*!*********************************!*\
  !*** ./js/modules/nojs/nojs.js ***!
  \*********************************/
/*! exports provided: removeNoJs, header */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var buttonsScroll = document.querySelectorAll('[data-scroll]');
...
/***/ "./js/modules/toggle-button/togle-button.js":
/*!**************************************************!*\
  !*** ./js/modules/toggle-button/togle-button.js ***!
  \**************************************************/
...
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/scroll-lock */ "./js/utils/scroll-lock.js");
/* harmony import */ var _nojs_nojs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../nojs/nojs */ "./js/modules/nojs/nojs.js");
...
var openMenu = function openMenu() {
  ...
  _nojs_nojs__WEBPACK_IMPORTED_MODULE_1__["header"].classList.add('is-open');
...
var closeMenu = function closeMenu() {
  ...
  _nojs_nojs__WEBPACK_IMPORTED_MODULE_1__["header"].classList.remove('is-open');
...
var addLinkClick = function addLinkClick() {
  buttonsMenu.forEach(function (buttonMenu) {
    return buttonMenu.addEventListener('click', closeMenu);
  });
};
var removeLinkClick = function removeLinkClick() {
  buttonsMenu.forEach(function (buttonMenu) {
    return buttonMenu.removeEventListener('click', closeMenu);
  });
};
...
var breakpointToggle = window.matchMedia('(min-width:768px)');
